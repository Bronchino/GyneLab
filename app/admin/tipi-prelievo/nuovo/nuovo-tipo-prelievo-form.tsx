...
export default function NuovoTipoPrelievoForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Errore durante la creazione della tipologia')
      setLoading(false)
    }
  }
