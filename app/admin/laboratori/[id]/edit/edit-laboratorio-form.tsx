...
interface EditLaboratorioFormProps {
  laboratorio: Laboratorio
}

export default function EditLaboratorioForm({ laboratorio }: EditLaboratorioFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    indirizzo: laboratorio.indirizzo || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.indirizzo) updateData.indirizzo = formData.indirizzo
      else updateData.indirizzo = null
      ...
      setError('Errore durante l\'aggiornamento del laboratorio')
      setLoading(false)
    }
  }
